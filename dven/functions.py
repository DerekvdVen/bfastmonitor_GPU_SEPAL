...
def set_paths(timeseries_directory,sh, sm, em, parameter_string, save_location=None, check_existing=False):
    ...
    for file in file_list:
        if file.startswith('tile'):
            ...
            if check_existing == False:
                ...
                output_path = file + '_' + str(sh.date()) + "_" + str(sm.date()) + "_" + str(em.date()) + "_" + parameter_string + "_meta_data.txt"
